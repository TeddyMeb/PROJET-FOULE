...
public class TestSimulation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Point sortie = new Point(200,550);
        Point sortie2 = new Point(600,550);
        
        Foule foule1 = new Foule(new ArrayList<>(),sortie);
        Foule foule2 = new Foule(new ArrayList<>(),sortie2);
        
        if (mode==1){
            foule1.positionAgentAleatoire(50);
            foule2.positionAgentAleatoire(50);
        }
        
        if (mode==2){
            foule1.positionAgentEnGrille(15,10,70,50,30);
            foule2.positionAgentEnGrille(15,10,470,50,30);
        }
        
        if (mode==3){
            foule1.positionAgentEnCercle(50, new Point(400,300),250);
        }
